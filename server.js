...
app.listen(PORT, () => {
  console.log(`\n🚀 Demo Generator running at http://localhost:${PORT}`);
  console.log(`   ComunicAI → http://localhost:${PORT}/comunicai/login.html`);
  console.log(`   MedicAI   → http://localhost:${PORT}/medicai/login.html`);
  console.log(`\n📋 Default credentials (password: password)`);
  console.log(`   admin / mario.rossi / giulia.bianchi`);
  console.log(`\n⚠️  Change passwords in backend/users.json before production!\n`);
});
